//! `std/compress/flate/token.zig` from Zig 0.16.0, unchanged but for its
//! std import: the deflate length and distance tables `Decompress.zig`
//! beside it reads. Copyright (c) Zig contributors, under the MIT license.
